...
int color[MXN],ans[MXN];
set<int> st[MXN];   //same code with long long was getting RTE due to stackoverflow,I tried to rum this same code in my computer and its still RTE
vi adj[MXN];
