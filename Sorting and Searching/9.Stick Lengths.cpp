...
ll v[MXN];
/*
This reduces to minimizing the function y=|x-x1|+|x-x2|.....|x-xn| for any x.
The graph for above function is similar to combinations of st. lines forming upward parabola
like structure and is symmetrical about median.
*/
int main()
{
    IP
